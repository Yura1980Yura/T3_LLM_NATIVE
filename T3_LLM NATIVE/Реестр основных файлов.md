...
[[Общий стек/Компонент PatchManager (Концепция системы патчей для DevAgent LLM NATIVE)|Компонент PatchManager (Концепция системы патчей для DevAgent LLM NATIVE)]]
